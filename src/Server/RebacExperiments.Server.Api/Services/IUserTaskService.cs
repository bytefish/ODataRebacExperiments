...
namespace RebacExperiments.Server.Api.Services
{
    ...
    public interface IUserTaskService
    {
        ...
        /// <summary>
        /// Queries for <see cref="UserTask"/> for a given <see cref="User"/>.
        /// </summary>
        /// <param name="context"><see cref="ApplicationDbContext"/> to use</param>
        /// <param name="currentUserId"><see cref="User"/> ID</param>
        /// <returns>Queryable for <see cref="UserTask"/> of a <see cref="User"/></returns>
        IQueryable<UserTask> QueryUserTasks(ApplicationDbContext context, int currentUserId);
    }
}
